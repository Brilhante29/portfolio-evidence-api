...
- README carries the measured primary value.
- Project validator and benchmark schema/digest validation pass.
- Reuse kit PR #4 passed CI and merged.

Pending:

- GitHub repository publication and green CI
