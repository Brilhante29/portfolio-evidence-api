...
The clean Node 24 Docker baseline reached 40.201 ms ingestion p95, 438.148 requests/second, and 24.119 ms GraphQL p95 with zero failures. The useful comparison is not Node versus another language yet. It is unverifiable output versus evidence that another machine can reject, reproduce, and compare.
